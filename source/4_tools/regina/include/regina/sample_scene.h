...
namespace regina
{
  class SampleScene : public rex::Scene
  {
  public:
    SampleScene();
  ...
  private:
    ...
    rex::Submesh build_submesh(const rex::mesh_factory::MeshData16& meshData, rsl::vector<rex::VertexPosNormCol>& vertices, rsl::vector<u16>& indices);

  private:
    rsl::unique_ptr<rex::Mesh> m_geometry;
