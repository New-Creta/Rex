...
VOID DokanDeleteFcb(__in PDokanVCB Vcb, __in PDokanFCB Fcb, __in BOOLEAN RemoveFromTable);
...
VOID DokanRenameFcb(__in PREQUEST_CONTEXT Request, __in PDokanFCB Fcb, __in PWCH FileName, __in USHORT FileNameLength);
