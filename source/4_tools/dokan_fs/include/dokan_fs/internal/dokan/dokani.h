...
#define IOEVENT_RESULT_BUFFER_SIZE(ioEvent) ((ioEvent)->EventResultSize >= offsetof(EVENT_INFORMATION, Buffer) ? (ioEvent)->EventResultSize - offsetof(EVENT_INFORMATION, Buffer) : 0)
