...
#define DOKAN_IO_BATCH_SIZE              ((SIZE_T)(FIELD_OFFSET(DOKAN_IO_BATCH, EventContext)) + BATCH_EVENT_CONTEXT_SIZE)

#define DOKAN_EVENT_INFO_16K_SIZE  (FIELD_OFFSET(EVENT_INFORMATION, Buffer) + (16 * 1024))
#define DOKAN_EVENT_INFO_32K_SIZE  (FIELD_OFFSET(EVENT_INFORMATION, Buffer) + (32 * 1024))
#define DOKAN_EVENT_INFO_64K_SIZE  (FIELD_OFFSET(EVENT_INFORMATION, Buffer) + (64 * 1024))
#define DOKAN_EVENT_INFO_128K_SIZE (FIELD_OFFSET(EVENT_INFORMATION, Buffer) + (128 * 1024))
