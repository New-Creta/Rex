...
typedef NTKERNELAPI BOOLEAN DokanPtr_FsRtlCheckLockForOplockRequest(_In_ PFILE_LOCK FileLock, _In_ PLARGE_INTEGER AllocationSize);
typedef NTKERNELAPI BOOLEAN DokanPtr_FsRtlAreThereWaitingFileLocks(_In_ PFILE_LOCK FileLock);

// extern GetSystemRoutineAddress
extern DokanPtr_FsRtlCheckLockForOplockRequest* DokanFsRtlCheckLockForOplockRequest;
extern DokanPtr_FsRtlAreThereWaitingFileLocks* DokanFsRtlAreThereWaitingFileLocks;
...
#define DOKAN_SYMBOLIC_LINK_NAME L"\\DosDevices\\Global\\Volume"
  ...
  #define DOKAN_GLOBAL_DEVICE_NAME L"\\Device\\" DOKAN_DEVICE_PREFIX_NAME L"_" DOKAN_MAJOR_API_VERSION
#endif
#ifndef DOKAN_GLOBAL_SYMBOLIC_LINK_NAME
  #define DOKAN_GLOBAL_SYMBOLIC_LINK_NAME L"\\DosDevices\\Global\\" DOKAN_DEVICE_PREFIX_NAME L"_" DOKAN_MAJOR_API_VERSION
#endif
#ifndef DOKAN_GLOBAL_FS_DISK_DEVICE_NAME
  #define DOKAN_GLOBAL_FS_DISK_DEVICE_NAME L"\\Device\\" DOKAN_DEVICE_PREFIX_NAME L"Fs" DOKAN_MAJOR_API_VERSION
#endif
#ifndef DOKAN_GLOBAL_FS_CD_DEVICE_NAME
  #define DOKAN_GLOBAL_FS_CD_DEVICE_NAME L"\\Device\\" DOKAN_DEVICE_PREFIX_NAME L"CdFs" DOKAN_MAJOR_API_VERSION
#endif
#ifndef DOKAN_NET_DEVICE_NAME
  #define DOKAN_NET_DEVICE_NAME L"\\Device\\" DOKAN_DEVICE_PREFIX_NAME L"Redirector" DOKAN_MAJOR_API_VERSION
#endif
#ifndef DOKAN_NET_SYMBOLIC_LINK_NAME
  #define DOKAN_NET_SYMBOLIC_LINK_NAME L"\\DosDevices\\Global\\" DOKAN_DEVICE_PREFIX_NAME L"Redirector" DOKAN_MAJOR_API_VERSION
#endif
...
#define MmGetSystemAddressForMdlNormalSafe(mdl) MmGetSystemAddressForMdlSafe(mdl, NormalPagePriority | DokanMdlSafePriority)
...
#define DokanResourceLockRW(resource) ExEnterCriticalRegionAndAcquireResourceExclusive(resource)

#define DokanResourceUnlock(resource) ExReleaseResourceAndLeaveCriticalRegion(resource)

VOID DokanResourceLockWithDebugInfo(__in BOOLEAN Writable, __in PERESOURCE Resource, __in PDokanResourceDebugInfo DebugInfo, __in PDOKAN_LOGGER Logger, __in const char* Site, const __in UNICODE_STRING* ResourceName, __in const void* ResourcePointer);

VOID DokanResourceUnlockWithDebugInfo(__in PERESOURCE Resource, __in PDokanResourceDebugInfo DebugInfo);
...
#define DokanFCBLockRW(fcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(TRUE, (fcb)->AdvancedFCBHeader.Resource, &(fcb)->ResourceDebugInfo, &(fcb)->Vcb->ResourceLogger, DokanCallSiteID, &(fcb)->FileName, (fcb));                                                                         \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanFCBLockRO(fcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(FALSE, (fcb)->AdvancedFCBHeader.Resource, &(fcb)->ResourceDebugInfo, &(fcb)->Vcb->ResourceLogger, DokanCallSiteID, &(fcb)->FileName, (fcb));                                                                        \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanFCBUnlock(fcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceUnlockWithDebugInfo((fcb)->AdvancedFCBHeader.Resource, &(fcb)->ResourceDebugInfo);                                                                                                                                                    \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanPagingIoLockRW(fcb)                                                                                                                                                                                                                         \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(TRUE, &(fcb)->PagingIoResource, &(fcb)->PagingIoResourceDebugInfo, &(fcb)->Vcb->ResourceLogger, DokanCallSiteID, &(fcb)->FileName, (fcb));                                                                          \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanPagingIoLockRO(fcb)                                                                                                                                                                                                                         \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(FALSE, &(fcb)->PagingIoResource, &(fcb)->PagingIoResourceDebugInfo, &(fcb)->Vcb->ResourceLogger, DokanCallSiteID, &(fcb)->FileName, (fcb));                                                                         \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanPagingIoUnlock(fcb)                                                                                                                                                                                                                         \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceUnlockWithDebugInfo(&(fcb)->PagingIoResource, &(fcb)->PagingIoResourceDebugInfo);                                                                                                                                                     \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanVCBLockRW(vcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(TRUE, &(vcb)->Resource, &(vcb)->ResourceDebugInfo, &(vcb)->ResourceLogger, DokanCallSiteID, (vcb)->Dcb->MountPoint, (vcb));                                                                                         \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanVCBLockRO(vcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceLockWithDebugInfo(FALSE, &(vcb)->Resource, &(vcb)->ResourceDebugInfo, &(vcb)->ResourceLogger, DokanCallSiteID, (vcb)->Dcb->MountPoint, (vcb));                                                                                        \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
#define DokanVCBUnlock(vcb)                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                      \
    if(DokanLockDebugEnabled())                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                    \
      DokanResourceUnlockWithDebugInfo(&(vcb)->Resource, &(vcb)->ResourceDebugInfo);                                                                                                                                                                     \
    }                                                                                                                                                                                                                                                    \
    else                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                    \
...
NTSTATUS DokanCheckOplock(__in PDokanFCB Fcb, __in PIRP Irp, __in_opt PVOID Context, __in_opt POPLOCK_WAIT_COMPLETE_ROUTINE CompletionRoutine, __in_opt POPLOCK_FS_PREPOST_IRP PostIrpRoutine);
...
_Function_class_(DRIVER_DISPATCH) _IRQL_requires_max_(APC_LEVEL) _IRQL_requires_same_ typedef NTSTATUS DOKAN_DISPATCH(_In_ struct _DEVICE_OBJECT* DeviceObject, _Inout_ struct _IRP* Irp);
// clang-format off
...
NTSTATUS DokanBuildRequestContext(_In_ PDEVICE_OBJECT DeviceObject, _In_ PIRP Irp, BOOLEAN IsTopLevelIrp, _Outptr_ PREQUEST_CONTEXT RequestContext);
...
NTSTATUS
DokanDispatchRequest(__in PDEVICE_OBJECT DeviceObject, __in PIRP Irp, BOOLEAN IsTopLevelIrp);

NTSTATUS
DokanEventRelease(__in_opt PREQUEST_CONTEXT RequestContext, __in PDEVICE_OBJECT DeviceObject);
...
PEVENT_CONTEXT
AllocateEventContext(__in PREQUEST_CONTEXT RequestContext, __in ULONG EventContextLength, __in_opt PDokanCCB Ccb);
...
VOID DokanEventNotification(__in PREQUEST_CONTEXT RequestContext, __in PIRP_LIST NotifyEvent, __in PEVENT_CONTEXT EventContext);

VOID DokanCompleteDirectoryControl(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteRead(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteWrite(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);
...
VOID DokanCancelCreateIrp(__in PREQUEST_CONTEXT RequestContext, __in NTSTATUS Status);

VOID DokanCompleteCreate(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteCleanup(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteLock(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteQueryVolumeInformation(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteFlush(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteQuerySecurity(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);

VOID DokanCompleteSetSecurity(__in PREQUEST_CONTEXT RequestContext, __in PEVENT_INFORMATION EventInfo);
...
NTSTATUS
DokanCreateDiskDevice(__in PDRIVER_OBJECT DriverObject, __in ULONG MountId, __in PWCHAR MountPoint, __in PWCHAR UNCName, __in_opt PSECURITY_DESCRIPTOR VolumeSecurityDescriptor, __in ULONG sessionID, __in PWCHAR BaseGuid,
                      __in PDOKAN_GLOBAL DokanGlobal, __in DEVICE_TYPE DeviceType, __in ULONG DeviceCharacteristics, __in BOOLEAN MountGlobally, __in BOOLEAN UseMountManager, __out PDOKAN_CONTROL DokanControl);

VOID DokanInitVpb(__in PVPB Vpb, __in PDEVICE_OBJECT VolumeDevice);
VOID DokanDeleteDeviceObject(__in_opt PREQUEST_CONTEXT RequestContext, __in PDokanDCB Dcb);
VOID DokanDeleteMountPoint(__in_opt PREQUEST_CONTEXT RequestContext, __in PDokanDCB Dcb);

// Create FSCTL_SET_REPARSE_POINT payload request aim to be sent with
// SendDirectoryFsctl.
PCHAR CreateSetReparsePointRequest(__in PREQUEST_CONTEXT RequestContext, __in PUNICODE_STRING SymbolicLinkName, __out PULONG Length);

// Create FSCTL_DELETE_REPARSE_POINT payload request aim to be sent with
// SendDirectoryFsctl.
PCHAR CreateRemoveReparsePointRequest(__in_opt PREQUEST_CONTEXT RequestContext, __out PULONG Length);

// Open a Directory path and send a FsControl with the input buffer.
NTSTATUS SendDirectoryFsctl(__in_opt PREQUEST_CONTEXT RequestContext, __in PUNICODE_STRING Path, __in ULONG Code, __in PCHAR Input, __in ULONG Length);
...
NTSTATUS DokanNotifyReportChange0(__in PREQUEST_CONTEXT RequestContext, __in PDokanFCB Fcb, __in PUNICODE_STRING FileName, __in ULONG FilterMatch, __in ULONG Action);

NTSTATUS DokanNotifyReportChange(__in PREQUEST_CONTEXT RequestContext, __in PDokanFCB Fcb, __in ULONG FilterMatch, __in ULONG Action);
...
PMOUNT_ENTRY InsertMountEntry(PDOKAN_GLOBAL dokanGlobal, PDOKAN_CONTROL DokanControl, BOOLEAN lockGlobal);

PMOUNT_ENTRY FindMountEntry(__in PDOKAN_GLOBAL dokanGlobal, __in PDOKAN_CONTROL DokanControl, __in BOOLEAN lockGlobal);

PMOUNT_ENTRY FindMountEntryByName(__in PDOKAN_GLOBAL DokanGlobal, __in PUNICODE_STRING DiskDeviceName, __in PUNICODE_STRING UNCName, __in BOOLEAN LockGlobal);

NTSTATUS DokanAllocateMdl(__in PREQUEST_CONTEXT RequestContext, __in ULONG Length);
...
// FCB.
void OplockDebugRecordMajorFunction(__in PDokanFCB Fcb, __in UCHAR MajorFunction);
...
// if applicable.
void OplockDebugRecordRequest(__in PDokanFCB Fcb, __in ULONG FsControlMinorFunction, __in ULONG OplockLevel);
...
void OplockDebugRecordCreateRequest(__in PDokanFCB Fcb, __in ACCESS_MASK AccessMask, __in ULONG ShareAccess);
