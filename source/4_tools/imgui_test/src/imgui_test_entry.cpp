...
#include "imgui/platform/win/imgui_impl_dx12.h"
  ...
  namespace rex
{
  ApplicationCreationParams app_entry(PlatformCreationParams& platformParams)
  {
    ...
    app_params.engine_params.app_init_func = imgui_test::initialize;
    app_params.engine_params.app_update_func = imgui_test::update;
    app_params.engine_params.app_shutdown_func = imgui_test::shutdown;
