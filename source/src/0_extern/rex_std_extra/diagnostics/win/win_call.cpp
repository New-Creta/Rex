...
rsl::win::WinCall::WinCall(const rsl::string_view file, const rsl::string_view function, card32 line_nr)
  : WinCall(ERROR_SUCCESS, file, function, line_nr)
{}

rsl::win::WinCall::WinCall(DWord error_success, const rsl::string_view file, const rsl::string_view function, card32 line_nr)
...
rsl::string_view rsl::win::WinCall::error_message() const
{
  return m_error_message.to_view();
}

void rsl::win::check_for_win_errors(const rsl::string_view file, const rsl::string_view function, card32 line_nr)
{
