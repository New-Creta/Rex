    ...
    namespace string_operations
    {
        ...
        std::string& str_tolower(std::string& s)
        {
            std::transform(s.begin(), s.end(), s.begin(), [](unsigned char c)
                           {
                               return rtl::numeric_cast<uint8>(std::tolower(c));
                           });
            return s;
        }
        //-------------------------------------------------------------------------
        std::string& str_toupper(std::string& s)
        {
            std::transform(s.begin(), s.end(), s.begin(), [](unsigned char c)
                           {
                               return rtl::numeric_cast<uint8>(std::toupper(c));
                           });
            return s;
        }
        ...
        std::string str_tolower_copy(const std::string& s)
        {
            ...
            for (auto& c : s)
            {
                new_s.push_back(rtl::numeric_cast<uint8>(std::tolower(c)));
            }
            return new_s;
        }
        //-------------------------------------------------------------------------
        std::string str_toupper_copy(const std::string& s)
        {
            ...
            for (auto& c : s)
            {
                new_s.push_back(rtl::numeric_cast<uint8>(std::toupper(c)));
            }
            return s;
        }
        ...
        bool starts_with(const std::string& str, const char* prefix)
        {
            return starts_with(str, prefix, rtl::numeric_cast<uint32>(std::string::traits_type::length(prefix)));
        }
        //-------------------------------------------------------------------------
        ...
        bool ends_with(const std::string& str, const char* suffix)
        {
            return ends_with(str, suffix, rtl::numeric_cast<uint32>(std::string::traits_type::length(suffix)));
        }
