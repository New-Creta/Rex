...
//
//                rsl::unique_array<ShaderConstantDesc> constants{};
//                rsl::unique_array<ShaderViewDesc> views{};
//                rsl::unique_array<DescriptorTableDesc> desc_tables{};
//                rsl::unique_array<ShaderSamplerDesc> samplers{};
//            };
//        } // namespace resources
//
