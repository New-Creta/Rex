	...
	namespace gfx
	{
		namespace d3d
		{
			...
			D3D12_DESCRIPTOR_RANGE to_dx12(ViewRangeDesc range)
			{
				...
				range_desc.BaseShaderRegister:
				range_desc.NumDescriptors :
					range_desc.OffsetInDescriptorsFromTableStart :
					range_desc.RangeType :
					range_desc.RegisterSpace :
