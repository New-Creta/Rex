...
namespace rex
{
  namespace rhi
  {
    ...
    void UploadBuffer::write(ID3D12GraphicsCommandList* cmdList, Resource* dstResource, const void* data, s64 size, s32 alignment)
    {
      ...
      dstResource->write_buffer(cmdList, this, m_offset, size);
