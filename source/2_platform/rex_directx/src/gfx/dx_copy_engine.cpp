...
namespace rex
{
  namespace rhi
  {
    ...
    DxCopyEngine::DxCopyEngine(rhi::ResourceStateTracker* globalResourceStateTracker)
    ...
    {
      wrl::ComPtr<ID3D12GraphicsCommandList> cmdlist = rhi::create_commandlist(alloc, rhi::GraphicsEngineType::Copy);
      cmdlist->Close();
