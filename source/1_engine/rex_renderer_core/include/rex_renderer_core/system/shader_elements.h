...
namespace rex
{
  namespace gfx
  {
    ...
    struct ViewRangeDesc // Perhaps rename to view range desc
    {
    ...
    struct RootSignatureDesc
    {
      ...
      rsl::unique_array<ViewTableDesc> desc_tables; // all the descriptor tables describing the various views and samplers of the shaders
