...
namespace rex
{
  namespace gfx
  {
    ...
    struct DepthStencilOpDesc
    {
      ...
      ComparisonFunc stencil_func;  // Function describing what to do with the stencil and the existing stencil data
    };
    ...
    struct DepthStencilDesc
    {
      ...
      ComparisonFunc depth_func;  // Function describing how to compare depth data against existing depth data
