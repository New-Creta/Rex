...
//    };
    ...
    //{
    //  backend::set_render_targets(colorTargets, numColorTargets, depthTarget);
    ...
    //{
    //  return backend::set_primitive_topology(primitiveTopology);
    ...
    //bool flush()
    //{
    //  return backend::flush_command_queue();
