...
//  namespace renderer
//  {
//    FrameData::FrameData(const rex::rhi::ResourceSlot& frameSlot)
...
//
//    //-------------------------------------------------------------------------
//    void FrameData::add_object_constant_buffer_slot(s32 frameIndex, const rex::rhi::ResourceSlot & committedResourceSlot, s32 bufferSize)
//    {
...
//
//      rex::rhi::ResourceSlot const object_constant_buffer = rex::renderer::create_constant_buffer_view(rsl::move(create_const_buffer_command_desc));
//
//      m_object_constant_buffer_slots.push_back(object_constant_buffer);
//    }
//
//    //-------------------------------------------------------------------------
//    void FrameData::set_pass_constant_buffer_slot(s32 frameIndex, const rex::rhi::ResourceSlot & committedResourceSlot, s32 bufferSize)
//    {
//      rex::renderer::commands::CreateConstantBufferViewCommandDesc create_const_buffer_command_desc{};
//
//      create_const_buffer_command_desc.frame_index = frameIndex;
...
//      create_const_buffer_command_desc.buffer_size = bufferSize;
//
//      rex::rhi::ResourceSlot pass_constant_buffer = rex::renderer::create_constant_buffer_view(rsl::move(create_const_buffer_command_desc));
//
//      m_pass_constant_buffer_slot = rsl::move(pass_constant_buffer);
//    }
//
//    //-------------------------------------------------------------------------
//    const rex::rhi::ResourceSlot& FrameData::frame_slot() const
//    {
//      return m_frame_slot;
//    }
//
//    //-------------------------------------------------------------------------
//    const rex::rhi::ResourceSlot& FrameData::object_committed_resource_slot() const
//    {
//      return m_object_committed_resource_slot;
//    }
//
//    //-------------------------------------------------------------------------
//    const rex::rhi::ResourceSlot& FrameData::pass_committed_resource_slot() const
//    {
//      return m_pass_committed_resource_slot;
//    }
//
//    //-------------------------------------------------------------------------
//    const rsl::vector<rex::rhi::ResourceSlot>& FrameData::object_constant_buffer_slots() const
//    {
//      return m_object_constant_buffer_slots;
//    }
//
//    //-------------------------------------------------------------------------
//    const rex::rhi::ResourceSlot& FrameData::pass_constant_buffer_slot() const
//    {
