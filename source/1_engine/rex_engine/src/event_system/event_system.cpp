  ...
  namespace event_system
  {
    ...
    void enqueue_event(const Event& evt)
    {
      switch(evt.type)
      {
        ...
        case EventType::WindowStopWindowResize: REX_VERBOSE(LogEngine, "Firing event: Event Type: {0}", rsl::enum_refl::enum_name(evt.type)); break;
        case EventType::WindowMinimized:
        case EventType::WindowMaximized:
        case EventType::WindowRestored: REX_VERBOSE(LogEngine, "Firing event: Event Type: {0} - Window Size: [{1}, {2}]", rsl::enum_refl::enum_name(evt.type), evt.data.window_resize.window_width, evt.data.window_resize.window_height); break;
      }
