...
namespace rex
{
  namespace log
  {
    namespace details
    {
      ...
      //-------------------------------------------------------------------------
      void CharacterFormatter::format(const details::LogMsg& /*unused*/, const tm& /*unused*/, memory_buf_t& dest)
      {
      ...
      //-------------------------------------------------------------------------
      void AggregateFormatter::format(const details::LogMsg& /*unused*/, const tm& /*unused*/, memory_buf_t& dest)
      {
      ...
      //-------------------------------------------------------------------------
      void ColorStartFormatter::format(const details::LogMsg& msg, const tm& /*unused*/, memory_buf_t& dest)
      {
      ...
      //-------------------------------------------------------------------------
      void ColorStopFormatter::format(const details::LogMsg& msg, const tm& /*unused*/, memory_buf_t& dest)
      {
      ...
      //-------------------------------------------------------------------------
      void FullFormatter::format(const details::LogMsg& msg, const tm& tmTime, memory_buf_t& dest)
      {
