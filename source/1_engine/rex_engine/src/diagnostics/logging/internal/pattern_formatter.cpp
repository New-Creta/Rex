...
namespace rexlog
{
  ...
  PatternFormatter::PatternFormatter(rex::DebugString pattern, PatternTimeType timeType, rex::DebugString eol, custom_flags customUserFlags)
  ...
  PatternFormatter::PatternFormatter(PatternTimeType timeType, rex::DebugString eol)
      : m_pattern("%+")
      , m_eol(rsl::move(eol))
      , m_pattern_time_type(timeType)
  ...
  rsl::unique_ptr<formatter> PatternFormatter::clone() const
  {
  ...
  void PatternFormatter::set_pattern(rex::DebugString pattern)
  {
    m_pattern        = rsl::move(pattern);
    m_need_localtime = false;
    compile_pattern_impl(m_pattern);
  ...
  tm PatternFormatter::get_time_impl(const details::LogMsg& msg)
  {
  ...
  // Return padding.
  details::PaddingInfo PatternFormatter::handle_padspec_impl(rex::DebugString::const_iterator& it, rex::DebugString::const_iterator end)
  {
  ...
  void PatternFormatter::compile_pattern_impl(const rex::DebugString& pattern)
  {
