...
template class REXLOG_API rexlog::sinks::wincolor_sink<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::wincolor_sink<rexlog::details::ConsoleNullMutex>;
template class REXLOG_API rexlog::sinks::wincolor_stdout_sink<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::wincolor_stdout_sink<rexlog::details::ConsoleNullMutex>;
template class REXLOG_API rexlog::sinks::wincolor_stderr_sink<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::wincolor_stderr_sink<rexlog::details::ConsoleNullMutex>;
#else
...
template REXLOG_API rsl::shared_ptr<rexlog::logger> rexlog::stdout_color_mt<rexlog::SynchronousFactory>(const rex::DebugString& logger_name, color_mode mode);
template REXLOG_API rsl::shared_ptr<rexlog::logger> rexlog::stdout_color_st<rexlog::SynchronousFactory>(const rex::DebugString& logger_name, color_mode mode);
template REXLOG_API rsl::shared_ptr<rexlog::logger> rexlog::stderr_color_mt<rexlog::SynchronousFactory>(const rex::DebugString& logger_name, color_mode mode);
template REXLOG_API rsl::shared_ptr<rexlog::logger> rexlog::stderr_color_st<rexlog::SynchronousFactory>(const rex::DebugString& logger_name, color_mode mode);
