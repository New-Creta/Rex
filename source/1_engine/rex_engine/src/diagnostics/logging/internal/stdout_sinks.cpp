...
template class REXLOG_API rexlog::sinks::stdout_sink_base<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::stdout_sink_base<rexlog::details::ConsoleNullMutex>;
template class REXLOG_API rexlog::sinks::stdout_sink<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::stdout_sink<rexlog::details::ConsoleNullMutex>;
template class REXLOG_API rexlog::sinks::stderr_sink<rexlog::details::ConsoleMutex>;
template class REXLOG_API rexlog::sinks::stderr_sink<rexlog::details::ConsoleNullMutex>;
