...
namespace rexlog
{
    namespace level
    {
        ...
        static rsl::array<rsl::string_view, 7> g_level_string_views = 
        {
            g_level_name_trace,
            g_level_name_debug,
            g_level_name_info,
            g_level_name_warning,
            g_level_name_error,
            g_level_name_critical,
            g_level_name_off
        };

        static rsl::array<rsl::string_view, 7> g_short_level_names[]
        {
            g_level_sname_trace,
            g_level_sname_debug,
            g_level_sname_info,
            g_level_sname_warning,
            g_level_sname_error,
            g_level_sname_critical,
            g_level_sname_off
        };
