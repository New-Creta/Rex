#include "rex_engine/gfx/rendering/render_passes/tilemap_pass.h"
...
namespace rex
{
	namespace gfx
	{
		...
		TilemapPass::TilemapPass(const TilemapPassDynamicInputs& inputs)
		...
		void TilemapPass::update_dynamic_inputs(const TilemapPassDynamicInputs& inputs)
		{
		...
		void TilemapPass::update_tilemap(const TilemapPassUpdateParams& params)
		{
		...
		void TilemapPass::render(rex::gfx::RenderContext* renderCtx)
		{
			if (!m_tilemap)
			{
				return;
		...
		RenderPassDesc TilemapPass::create_desc() const
		{
			RenderPassDesc desc{};
		...
		void TilemapPass::init_vb(rex::gfx::RenderContext* renderCtx)
		{
		...
		void TilemapPass::init_ib(rex::gfx::RenderContext* renderCtx)
		{
			if (m_tiles_ib_gpu)
			{
				return;
		...
		void TilemapPass::init_render_info(rex::gfx::RenderContext* renderCtx)
		{
		...
		void TilemapPass::init_tile_indices_uab(rex::gfx::RenderContext* renderCtx)
		{
		...
		void TilemapPass::init_render_pass()
		{
