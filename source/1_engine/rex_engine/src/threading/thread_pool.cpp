...
namespace rex
{
  namespace thread_pool
  {
    namespace internal
    {
      ...
      public:
        ThreadPool()
        {
          ...
          s32 num_threads_to_spawn = rex::sys_info::number_logical_processors();
        ...
        {
          rsl::unique_lock lock(m_threads_access_mtx);
    ...
    void ThreadHandle::run(thread_work_func&& callable, void* arg)
    {
      m_thread->run(rsl::move(callable), arg);
    }
