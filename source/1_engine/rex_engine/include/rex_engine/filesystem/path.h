...
namespace rex
{
  namespace path
  {
    namespace internal
    {
      ...
      void join_impl(rsl::wstring& str, PathLikeType&& arg)
      {
        join_impl(str, rsl::wstring_view(rsl::forward<PathLikeType>(arg)));
      }
      template <typename PathLikeType, typename... Args>
      void join_impl(rsl::wstring& str, PathLikeType&& firstArg, Args&&... args)
      {
    ...
    rsl::wstring join(PathLikeTypes&&... paths)
    {
      rsl::wstring res;
    ...
    rsl::wstring abs_path(rsl::wstring_view path);
    ...
    struct SplitResult
    {
      rsl::wstring_view head;
      rsl::wstring_view tail;
    };
    ...
    {
      rsl::wstring_view drive;
      rsl::wstring_view root;
      rsl::wstring_view tail;
    };
