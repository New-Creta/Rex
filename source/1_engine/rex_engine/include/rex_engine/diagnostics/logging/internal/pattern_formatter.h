...
public:
    ...
    explicit pattern_formatter(rsl::string pattern, pattern_time_type time_type = pattern_time_type::local,
        rsl::string eol = rsl::string(rexlog::details::os::default_eol), custom_flags custom_user_flags = custom_flags());
