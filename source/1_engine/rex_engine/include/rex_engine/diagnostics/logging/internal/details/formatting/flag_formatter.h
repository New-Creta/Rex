  ...
  namespace log
  {
    namespace details
    {
      ...
      public:
        ...
        virtual void format(const details::LogMsg& msg, const tm& tmTime, rsl::string& dest) = 0;
      ...
      public:
        ...
        void format(const details::LogMsg& msg, const tm& /*unused*/, rsl::string& dest) override
        {
      ...
      public:
        ...
        void format(const details::LogMsg& /*unused*/, const tm& tmTime, rsl::string& dest) override
        {
      ...
      public:
        ...
        void format(const details::LogMsg& msg, const tm& tmTime, rsl::string& dest) override
        {
          const s32 field_size = 6;
          ScopedPadder p(field_size, padding_info(), dest);
      ...
      public:
        ...
        void format(const details::LogMsg& /*unused*/, const tm& /*unused*/, rsl::string& dest) override
        {
