...
namespace rexlog
{
    namespace sinks
    {
        ...
        protected:
            ...
            virtual void set_pattern_impl(const rsl::small_stack_string& pattern);
        ...
        template <typename Mutex>
        void  rexlog::sinks::BaseSink<Mutex>::set_pattern_impl(const rsl::small_stack_string& pattern)
        {
