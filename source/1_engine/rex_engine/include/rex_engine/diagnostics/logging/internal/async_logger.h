...
public:
    ...
    async_logger(rsl::string logger_name, It begin, It end, rsl::weak_ptr<details::thread_pool> tp,
    ...
    async_logger(rsl::string logger_name, sinks_init_list sinks_list, rsl::weak_ptr<details::thread_pool> tp,
        async_overflow_policy overflow_policy = async_overflow_policy::block);

    async_logger(rsl::string logger_name, sink_ptr single_sink, rsl::weak_ptr<details::thread_pool> tp,
        async_overflow_policy overflow_policy = async_overflow_policy::block);
