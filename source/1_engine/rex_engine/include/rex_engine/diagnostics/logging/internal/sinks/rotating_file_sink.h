...
{
public:
    rotating_file_sink(filename_t base_filename, rsl::size_t max_size, rsl::size_t max_files, bool rotate_on_open = false,
...
inline rsl::shared_ptr<logger> rotating_logger_mt(const rsl::string &logger_name, const filename_t &filename, size_t max_file_size,
...
template<typename Factory = rexlog::synchronous_factory>
inline rsl::shared_ptr<logger> rotating_logger_st(const rsl::string &logger_name, const filename_t &filename, size_t max_file_size,
    size_t max_files, bool rotate_on_open = false, const file_event_handlers &event_handlers = {})
{
