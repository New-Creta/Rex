...
inline rsl::shared_ptr<logger> syslog_logger_mt(const rsl::string &logger_name, const rsl::string &syslog_ident = "", int syslog_option = 0,
...
template<typename Factory = rexlog::synchronous_factory>
inline rsl::shared_ptr<logger> syslog_logger_st(const rsl::string &logger_name, const rsl::string &syslog_ident = "", int syslog_option = 0,
    int syslog_facility = LOG_USER, bool enable_formatting = false)
{
