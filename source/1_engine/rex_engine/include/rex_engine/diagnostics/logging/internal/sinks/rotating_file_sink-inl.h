...
REXLOG_INLINE rotating_file_sink<Mutex>::rotating_file_sink(
    filename_t base_filename, rsl::size_t max_size, rsl::size_t max_files, bool rotate_on_open, const file_event_handlers &event_handlers)
