...
struct daily_filename_calculator
{
    ...
    static filename_t calc_filename(const filename_t &filename, const tm &now_tm)
    {
        ...
        return filename_t(fmt_lib::format(REXLOG_FMT_STRING(REXLOG_FILENAME_T("{}_{:04d}-{:02d}-{:02d}{}")), filename_with_extension.filename, now_tm.tm_year + 1900,
            now_tm.tm_mon + 1, now_tm.tm_mday, filename_with_extension.ext));
    }
};
...
inline rsl::shared_ptr<logger> daily_logger_mt(const rsl::string &logger_name, const filename_t &filename, int hour = 0, int minute = 0,
...
template<typename Factory = rexlog::synchronous_factory>
inline rsl::shared_ptr<logger> daily_logger_format_mt(const rsl::string &logger_name, const filename_t &filename, int hour = 0,
...
template<typename Factory = rexlog::synchronous_factory>
inline rsl::shared_ptr<logger> daily_logger_st(const rsl::string &logger_name, const filename_t &filename, int hour = 0, int minute = 0,
    bool truncate = false, uint16_t max_files = 0, const file_event_handlers &event_handlers = {})
{
...
template<typename Factory = rexlog::synchronous_factory>
inline rsl::shared_ptr<logger> daily_logger_format_st(const rsl::string &logger_name, const filename_t &filename, int hour = 0,
    int minute = 0, bool truncate = false, uint16_t max_files = 0, const file_event_handlers &event_handlers = {})
{
