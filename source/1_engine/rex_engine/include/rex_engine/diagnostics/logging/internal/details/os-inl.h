...
REXLOG_INLINE rexlog::log_clock::time_point now() REXLOG_NOEXCEPT
{
    ...
    return rsl::chrono::time_point<log_clock, typename log_clock::duration>(
        rsl::chrono::duration_cast<typename log_clock::duration>(rsl::chrono::seconds(ts.tv_sec) + rsl::chrono::nanoseconds(ts.tv_nsec)));
...
REXLOG_INLINE bool is_color_terminal() REXLOG_NOEXCEPT
{
    ...
    static const bool result = []() {
        ...
        static constexpr rsl::array<const char *, 16> terms = {{"ansi", "color", "console", "cygwin", "gnome", "konsole", "kterm", "linux",
