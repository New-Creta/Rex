...
template<class T>
struct is_convertible_to_any_format_string : rsl::integral_constant<bool, is_convertible_to_basic_format_string<T, char>::value ||
...
#    define REXLOG_LEVEL_NAMES                                                                                                             \
        {                                                                                                                                  \
            REXLOG_LEVEL_NAME_TRACE, REXLOG_LEVEL_NAME_DEBUG, REXLOG_LEVEL_NAME_INFO, REXLOG_LEVEL_NAME_WARNING, REXLOG_LEVEL_NAME_ERROR,  \
                REXLOG_LEVEL_NAME_CRITICAL, REXLOG_LEVEL_NAME_OFF                                                                          \
        }
#endif
...
[[noreturn]] REXLOG_API void throw_rexlog_ex(const rsl::string &msg, int last_errno);
[[noreturn]] REXLOG_API void throw_rexlog_ex(rsl::string msg);
