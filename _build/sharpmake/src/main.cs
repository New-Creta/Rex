...
// In the future we want to support other IDEs (like Visual Studio Code)
// when we reach that, we only have to implement the top part
// and make it connect to the Rex Python Script
//
//
