...
# include path: ${CMAKE_SOURCE_DIR}/source/include/3_app_libraries/rex_application_core
# src path: ${CMAKE_SOURCE_DIR}/source/src/3_app_libraries/rex_application_core


# Project Name Project
# -------------------------
file(GLOB_RECURSE rex_application_core_LIBS_INC    ${CMAKE_SOURCE_DIR}/source/include/3_app_libraries/rex_application_core/*.h)
file(GLOB_RECURSE rex_application_core_LIBS_SRC    ${CMAKE_SOURCE_DIR}/source/src/3_app_libraries/rex_application_core/*.cpp)


# Create the project filters
GROUPSOURCES(${CMAKE_SOURCE_DIR}/source/include/3_app_libraries/rex_application_core include)
GROUPSOURCES(${CMAKE_SOURCE_DIR}/source/src/3_app_libraries/rex_application_core src)
...
target_include_directories(rex_application_core PUBLIC ${CMAKE_SOURCE_DIR}/source/include/3_app_libraries/rex_application_core)

# Set the link libraries
target_link_libraries(rex_application_core PUBLIC rex_windows)

# Set project properties
set_target_properties(rex_application_core PROPERTIES FOLDER                                         	3_app_libraries)   				# solution folder
...
add_precompiled_header(rex_application_core "rex_application_core_pch.h" "rex_application_core_pch.cpp")