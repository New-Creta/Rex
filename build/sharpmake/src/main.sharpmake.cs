...
// the sample C++ code.
public class BaseCppProject : Project
{
  protected string IncludeFolder = "";

  public BaseCppProject() : base(typeof(RexTarget), typeof(RexConfiguration))
  {
  }
...
public class SharpmakeProject : CSharpProject
{
  public SharpmakeProject() : base(typeof(RexTarget), typeof(RexConfiguration))
  {
    ...
    //RexTarget ninjaTarget = new RexTarget(Platform.win64, DevEnv.ninja, Config.debug | Config.debug_opt | Config.release | Config.coverage, Compiler.MSVC | Compiler.Clang);
  ...
  public virtual void Configure(RexConfiguration conf, RexTarget target)
  {
    ...
    conf.EventPostBuild.Add($"{sharpmakeAppPath} {conf.CsprojUserFile.StartArguments}");
  }
}

// All third party libraries should inherit from this
public class ThirdPartyProject : BaseCppProject
{
...
public class EngineProject : BaseCppProject
{
...
public class PlatformProject : BaseCppProject
{
...
public class AppLibrariesProject : BaseCppProject
{
...
public class ToolsProject : BaseCppProject
{
